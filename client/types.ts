...
export type SlideQuery = { item?: Maybe<Pick<Slide, 'id' | 'title' | 'desc' | 'image'>> };
...
export type UpdateSlideMutation = { action: Mutation['updateSlide'] };

export type SlidesQueryVariables = Exact<{ [key: string]: never; }>;


export type SlidesQuery = { list?: Maybe<Array<Maybe<Pick<Slide, 'id' | 'title'>>>> };
...
export type RemoveSlideMutation = { action?: Maybe<Pick<Slide, 'id' | 'title'>> };

export type RemoveFragment = Pick<Slide, 'id'>;
...
export type AddSlideMutation = { action?: Maybe<Pick<Slide, 'id'>> };
...
export const RemoveMediaFragmentDoc = gql`
  ...
  id
    ...
    `;
export const RemoveFragmentDoc = gql`
 ...
 * __useSlideQuery__
 *
 * To run a query within a React component, call `useSlideQuery` and pass it any options that fit your needs.
 * When your component renders, `useSlideQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSlideQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
...
export function useSlideQuery(baseOptions: Apollo.QueryHookOptions<SlideQuery, SlideQueryVariables>) {
        return Apollo.useQuery<SlideQuery, SlideQueryVariables>(SlideDocument, baseOptions);
      }
export function useSlideLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SlideQuery, SlideQueryVariables>) {
          return Apollo.useLazyQuery<SlideQuery, SlideQueryVariables>(SlideDocument, baseOptions);
        }
...
export const UpdateSlideDocument = gql`
    mutation updateSlide($id: ID!, $title: String, $desc: String, $image: String) {
  action: updateSlide(id: $id, title: $title, desc: $desc, image: $image)
}
    `;
export type UpdateSlideMutationFn = Apollo.MutationFunction<UpdateSlideMutation, UpdateSlideMutationVariables>;
 ...
 * });
 */
export function useUpdateSlideMutation(baseOptions?: Apollo.MutationHookOptions<UpdateSlideMutation, UpdateSlideMutationVariables>) {
        return Apollo.useMutation<UpdateSlideMutation, UpdateSlideMutationVariables>(UpdateSlideDocument, baseOptions);
      }
export type UpdateSlideMutationHookResult = ReturnType<typeof useUpdateSlideMutation>;
export type UpdateSlideMutationResult = Apollo.MutationResult<UpdateSlideMutation>;
export type UpdateSlideMutationOptions = Apollo.BaseMutationOptions<UpdateSlideMutation, UpdateSlideMutationVariables>;
...
export function useSlidesQuery(baseOptions?: Apollo.QueryHookOptions<SlidesQuery, SlidesQueryVariables>) {
        return Apollo.useQuery<SlidesQuery, SlidesQueryVariables>(SlidesDocument, baseOptions);
      }
export function useSlidesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SlidesQuery, SlidesQueryVariables>) {
          return Apollo.useLazyQuery<SlidesQuery, SlidesQueryVariables>(SlidesDocument, baseOptions);
        }
...
export const RemoveSlideDocument = gql`
  ...
  action: removeSlide(id: $id) {
    ...
    `;
export type RemoveSlideMutationFn = Apollo.MutationFunction<RemoveSlideMutation, RemoveSlideMutationVariables>;

/**
 * __useRemoveSlideMutation__
 *
 * To run a mutation, you first call `useRemoveSlideMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRemoveSlideMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [removeSlideMutation, { data, loading, error }] = useRemoveSlideMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useRemoveSlideMutation(baseOptions?: Apollo.MutationHookOptions<RemoveSlideMutation, RemoveSlideMutationVariables>) {
        return Apollo.useMutation<RemoveSlideMutation, RemoveSlideMutationVariables>(RemoveSlideDocument, baseOptions);
      }
export type RemoveSlideMutationHookResult = ReturnType<typeof useRemoveSlideMutation>;
export type RemoveSlideMutationResult = Apollo.MutationResult<RemoveSlideMutation>;
export type RemoveSlideMutationOptions = Apollo.BaseMutationOptions<RemoveSlideMutation, RemoveSlideMutationVariables>;
export const AddSlideDocument = gql`
  ...
  action: addSlide(title: $title, desc: $desc, image: $image) {
    ...
    `;
export type AddSlideMutationFn = Apollo.MutationFunction<AddSlideMutation, AddSlideMutationVariables>;
 ...
 * });
 */
export function useAddSlideMutation(baseOptions?: Apollo.MutationHookOptions<AddSlideMutation, AddSlideMutationVariables>) {
        return Apollo.useMutation<AddSlideMutation, AddSlideMutationVariables>(AddSlideDocument, baseOptions);
      }
export type AddSlideMutationHookResult = ReturnType<typeof useAddSlideMutation>;
export type AddSlideMutationResult = Apollo.MutationResult<AddSlideMutation>;
export type AddSlideMutationOptions = Apollo.BaseMutationOptions<AddSlideMutation, AddSlideMutationVariables>;
